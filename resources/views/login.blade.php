            ...
            <div class="row">
                <div class="col-md-4 mx-auto">
                    <div class="section-title">
                        ...
                        <p>Bienvenue sur notre plateforme de connexion. Veuillez vous connecter avec votre adresse e-mail et votre mot de passe pour accéder à votre compte.
                            Si vous n'avez pas encore de compte, vous pouvez vous inscrire en suivant le lien "S'inscrire".</p>
                    </div>
                    <form method="POST" action="">
                        ...
                        <p class="text-center text-muted mt-5">Pas Encore inscrit ? <a href="/register">S'inscrire</a></p>
                    </form>
            </div>
        </div>
